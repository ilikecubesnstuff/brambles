...
\end{align}
$$
<p class="diagram-caption">4 frames represented in row diagrams. Note that spares are represented with exactly one ball to the right, and strikes are represented with both balls to the right.</p>
...
```
````
<p class="diagram-caption">3 example bowling games with 3 identical ending frames.</p>
...
```
````
<p class="diagram-caption">A game scoring (possibly) the hardest score to achieve in bowling.</p>
