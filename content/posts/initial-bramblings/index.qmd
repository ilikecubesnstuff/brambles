...
For code, I do not tinker much with Quarto's defaults beyond setting the color scheme to `monokai`. Code sample below:{{% sidenote %}}Code excerpt from a Python script for generating secret Santa pairings.{{% /sidenote %}}
